...
\setcounter{page}{\VAR{paper.page_range[0]}}
...
\AddToShipoutPicture*{
  ...
  \footnotesize
  \put(105,12){\makebox(0,0){\emph{Proceedings of the \VAR{conference.event_name}}, pages \VAR{paper.page_range[0]} - \VAR{paper.page_range[1]}}}
  \put(105,8){\makebox(0,0){\VAR{conference_dates}, \VAR{conference.start_date.year} 
