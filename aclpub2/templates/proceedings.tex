...
\begin{titlepage}
  \begin{center}
    ...
    {\bf\LARGE \VAR{conference.book_title}}
...
\BLOCK{for paper in papers}
  ...
  \AddToShipoutPicture*{
    ...
    \footnotesize
    \put(105,16){\makebox(0,0){\emph{Proceedings of the \VAR{conference.event_name}}, pages \VAR{paper.page_range[0]} - \VAR{paper.page_range[1]}}}
