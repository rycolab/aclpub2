...
{\Large The \VAR{conference.abbreviation} organizers gratefully acknowlege the support from the following sponsors.}
\bigskip
...
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in papers}
    \item \hyperlink{page.\VAR{paper.page_range[0]}}{\emph{\VAR{paper.title}}}\\ \hspace*{2em} \VAR{join(", ", paper.authors, " and ")}\dotfill \VAR{paper.page_range[0]}
  \BLOCK{endfor}
\end{itemize}
\newpage
